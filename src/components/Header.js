  ...
  return (
    <div className="Header">
      <div className="header-wrapper">
        ...
        <div className="info">
          <img alt="location" className="header-icon" src={location}></img>
          <div className="info-text">New York, NY</div>

          <img alt="email" className="header-icon" src={mail}></img>
          <div className="info-text">keonch91@gmail.com</div>

          <img alt="phone" className="header-icon" src={telephone}></img>
